...
Every figure above the design notes is read out of
`docs/relevance/baseline.json` or out of the sweep that ADR 10 records. None
of them is an estimate; the moved design notes carry their own measured
figures, each named where it was taken.
