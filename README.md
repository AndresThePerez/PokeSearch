...
The production instance runs on the home server (`USER@HOST`) in `~/apps/pokesearch`, published on host port **8083** (8080–8082 are taken by other services). The published port comes from a git-ignored `.env` file next to the compose files:
